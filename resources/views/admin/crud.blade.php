    ...
    @section('content2')
                ...
                <div class="mb-4">
                    <form action="{{ route('tours.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-3">
                                <input type="number" class="form-control" id="price" name="price" placeholder="Giá tour"
                                    value="{{ old('price') }}">
                                @error('price')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="row g-3 mt-2">
                            ...
                            <div class="col-md-3">
                                <select class="form-control" id="star_from" name="star_from">
                                    ...
                                    <option value="Bắc Giang" {{ old('star_from') == 'Bắc Giang' ? 'selected' : '' }}>Bắc
                                        Giang
                                    </option>
                                    ...
                                    <option value="Bình Định" {{ old('star_from') == 'Bình Định' ? 'selected' : '' }}>Bình
                                        Định
                                    </option>
                                    ...
                                    <option value="Bình Thuận" {{ old('star_from') == 'Bình Thuận' ? 'selected' : '' }}>Bình
                                        Thuận</option>
                                    <option value="Cà Mau" {{ old('star_from') == 'Cà Mau' ? 'selected' : '' }}>Cà Mau
                                    </option>
                                    ...
                                    <option value="Điện Biên" {{ old('star_from') == 'Điện Biên' ? 'selected' : '' }}>Điện
                                        Biên
                                    </option>
                                    <option value="Đồng Nai" {{ old('star_from') == 'Đồng Nai' ? 'selected' : '' }}>Đồng Nai
                                    </option>
                                    <option value="Đồng Tháp" {{ old('star_from') == 'Đồng Tháp' ? 'selected' : '' }}>Đồng
                                        Tháp
                                    </option>
                                    ...
                                    <option value="Hà Nam" {{ old('star_from') == 'Hà Nam' ? 'selected' : '' }}>Hà Nam
                                    </option>
                                    <option value="Hà Nội" {{ old('star_frombla') == 'Hà Nội' ? 'selected' : '' }}>Hà Nội
                                    </option>
                                    <option value="Hà Tĩnh" {{ old('star_from') == 'Hà Tĩnh' ? 'selected' : '' }}>Hà Tĩnh
                                    </option>
                                    <option value="Hải Dương" {{ old('star_from') == 'Hải Dương' ? 'selected' : '' }}>Hải
                                        Dương
                                    </option>
                                    <option value="Hải Phòng" {{ old('star_from') == 'Hải Phòng' ? 'selected' : '' }}>Hải
                                        Phòng
                                    </option>
                            ...
                            <div class="col-md-3">
                                <input type="number" class="form-control" id="total_seats" name="total_seats"
                                    placeholder="Số chỗ ngồi" value="{{ old('total_seats') }}" min="1"
                                    max="60" required>
                                @error('total_seats')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="row g-3 mt-2">
                            <div class="col-md-3">
                                <input type="number" class="form-control" id="tour_sale" name="tour_sale"
        ...
        <script>
            $(document).ready(function() {
                ...
                // Hàm kiểm tra validation cho từng trường
                function validateTourName() {
                    let input = $('#tour_name');
                    let value = input.val();
                    if (value.length > 250) {
                        showError(input, 'Tên tour không được vượt quá 250 ký tự!');
                        return false;
                    } else if (!value) {
                ...
                function validateTotalSeats() {
                    ...
                    if (isNaN(value) || value < 1) {
                        showError(input, 'Số chỗ ngồi phải lớn hơn 0!');
                        return false;
                    } else if (value > 60) {
                ...
                function validateTourSale() {
                    ...
                    if (isNaN(value) || value < 0) {
                        showError(input, 'Giảm giá phải lớn hơn hoặc bằng 0!');
                        return false;
                    } else if (value > 100) {
                ...
                // Sự kiện input/change để kiểm tra real-time
