...
class LienKetTrangController extends Controller
{
    ...
    public function index($page = "user.package")
    {
        $user_main =1; // Lấy thông tin người dùng đã đăng nhập
        $tours = Tour::orderByRaw('CAST(tour_sale AS UNSIGNED) DESC')->paginate(6);
