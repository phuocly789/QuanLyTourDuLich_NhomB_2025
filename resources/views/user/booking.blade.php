                ...
                <div class="row g-5">
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px;">
                        <div class="position-relative h-100">
                            <img class="img-fluid position-absolute w-100 h-100"
                                src="{{ asset('img/' . $value->tour_image) }}" alt="" style="object-fit: cover;">
                        </div>
                    </div>
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                        ...
                        <div class="row gy-2 gx-4 mb-4">
                            ...
                            <div class="col-sm-6">
                                <p class="mb-0"><i class="fa fa-hotel text-primary me-2"></i>Khách sạn: Khách sạn 5 sao
                                </p>
                            </div>
                            <div class="col-sm-6">
                                <p class="mb-0"><i class="fa fa-gifts text-primary me-2"></i>Đã bao gồm ưu đãi trong giá
                                    tour
                                </p>
                            </div>
                            <div class="col-sm-6">
                            ...
                            <form action="{{ route('booking.store', [$value->tour_id, Auth::user()->id]) }}"
                                ...
                                <div class="col-sm-6">
                                    <div class="quantity buttons_added">
                                        <input name="booking_quantity" id="quantityInput" style="text-align: center;"
                                            type="number" size="4" class="input-text qty text border-1"
                                            title="Qty" value="0" min="0" step="1">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    <div class="quantity buttons_added">
                                        <input name="booking_customer_phone" id="phoneInput" type="number"
            ...
            <div class="container">
                ...
                @if (Auth::check() && Auth::user()->bookings()->where('booking_tour_id', $value->tour_id)->exists())
                    ...
                    <form action="{{ route('clients.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <button type="submit" class="btn btn-primary rounded-pill py-2 px-4">Gửi đánh
                                    giá</button>
                            </div>
                        </div>
                    </form>
                @elseif (Auth::check())
                    <p class="text-center mb-5">Bạn cần <a
                            href="{{ route('booking.store', [$value->tour_id, Auth::user()->id]) }}">đặt tour</a> để gửi
                        đánh
                        giá.</p>
                @else
                    <p class="text-center mb-5">Vui lòng <a href="{{ route('login') }}">đăng nhập</a> và đặt tour để gửi
                        đánh
                        giá.</p>
                @endif
                    ...
                    @else
                        @foreach ($data_comment->reverse() as $row)
                            @if ($value->tour_id == $row->tour_id)
                                <div class="col-lg-1 wow fadeInUp mt-0 mb-0" data-wow-delay="0.1s"
